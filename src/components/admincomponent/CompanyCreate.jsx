...
import { setSelectedTutionCenter } from "@/redux/tutionCenterSlice";
  ...
  const registerNewTutionCenter = async () => {
    try {
      const res = await axios.post(
        `${TUTION_CENTER_API_ENDPOINT}/register`,
        { tutionCenterName },
        {
          headers: {
      ...
      if (res?.data?.success) {
        dispatch(setSelectedTutionCenter(res.data.tutionCenter));
    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="my-10">
          ...
          <p className="text-gray-600">Tution Center Description</p>
        </div>
